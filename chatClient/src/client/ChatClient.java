...
public class ChatClient extends UnicastRemoteObject implements InterfaceClient{
    ...
    public ChatClient(String name , InterfaceServer server,JTextArea jtext1,JTextArea jtext2,JPanel jpanel) throws RemoteException{
        ...
        this.output = jtext2;
        this.jpanel = jpanel;
        server.addClient1571020150(this);
    }
    
    @Override
    public void retrieveMessage1571020150(String message) throws RemoteException {
        output.setText(output.getText() + "\n" + message);
    }
    
    @Override
    public void retrieveMessage1571020150(String filename, ArrayList<Integer> inc) throws RemoteException {
    ...
    @Override
    public void sendMessage1571020150(List<String> list) {
        try {
            server.broadcastMessage1571020150(name + " : " + input.getText(),list);
    ...
    @Override
    public String getName1571020150() {
        return name;
    }

    @Override
    public void closeChat1571020150(String message) throws RemoteException {
    ...
    @Override
    public void openChat1571020150() throws RemoteException {
